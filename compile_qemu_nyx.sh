...
configure_qemu()
{
  ...
  case $1 in
    ...
    "lto")
      ...
      ;;
    "verbose")
      $QEMU_CONFIGURE --enable-nyx --enable-sanitizers --enable-debug --enable-nyx-verbose
      ;;
    "verbose_static")
      $QEMU_CONFIGURE --enable-nyx --enable-sanitizers --enable-debug --enable-nyx-verbose --enable-nyx-static
      ;;
    *)
      error
      ;;
...
case $1 in
    "dynamic"|"debug"|"debug_static"|"static"|"lto"|"verbose"|"verbose_static")
      ;;
    *)
      error
      ;;
